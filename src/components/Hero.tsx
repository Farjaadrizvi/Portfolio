...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-blue-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-6 py-20 text-center">
        ...
        <div className="flex justify-center space-x-4 mb-12">
          <a href="https://github.com/Farjaadrizvi" target="_blank" rel="noopener noreferrer" 
             className="social-link group">
            <Github className="w-6 h-6 group-hover:text-blue-500 transition-colors" />
          </a>
          <a href="https://linkedin.com/in/farjaadrizvi" target="_blank" rel="noopener noreferrer"
             className="social-link group">
            <Linkedin className="w-6 h-6 group-hover:text-blue-500 transition-colors" />
          </a>
          <a href="mailto:farjaadrizvi@gmail.com"
             className="social-link group">
